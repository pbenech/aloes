...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ife.aloes.type.cato_selector' => 'getIfe_Aloes_Type_CatoSelectorService',
            'ife.aloes.type.typo_selector' => 'getIfe_Aloes_Type_TypoSelectorService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'aloes', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_c9a7df56b7288de2b14d1ae829012c00002e14af0e7ec8f1b730d71672123f66');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_c9a7df56b7288de2b14d1ae829012c00002e14af0e7ec8f1b730d71672123f66');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_c9a7df56b7288de2b14d1ae829012c00002e14af0e7ec8f1b730d71672123f66');
        ...
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Ife\\AloesBundle\\Entity'))), 'Ife\\AloesBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'IfeAloesBundle' => 'Ife\\AloesBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Ife\\AloesBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Ife\\AloesBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Ife\\AloesBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fr3d_ldap.ldap_driver.legacy'] = new \FR3D\LdapBundle\Driver\LegacyLdapDriver(array('host' => 'ldap.XXX.fr', 'port' => 389, 'useStartTls' => false, 'useSsl' => false, 'bindRequiresDn' => false, 'baseDn' => 'ou=people, dc=ens-lyon, dc=fr', 'accountFilterFormat' => '(&(ObjectClass=Person))'), 3, $this->get('monolog.logger.ldap_driver'));
    }
    ...
    {
        return $this->services['fr3d_ldap.ldap_manager.default'] = new \FR3D\LdapBundle\Ldap\LdapManager($this->get('fr3d_ldap.ldap_driver.zend'), $this->get('fos_user.user_manager'), array('baseDn' => 'ou=people, dc=ens-lyon, dc=fr', 'filter' => '(&(ObjectClass=Person))', 'attributes' => array(0 => array('ldap_attr' => 'uid', 'user_method' => 'setUsername'), 1 => array('ldap_attr' => 'mail', 'user_method' => 'setEmail'), 2 => array('ldap_attr' => 'sn', 'user_method' => 'setSn'), 3 => array('ldap_attr' => 'givenname', 'user_method' => 'setGivenname'))));
    }
    ...
    {
        return $this->services['hautelook.router.template'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, (__DIR__.'/assetic/routing.yml'), array('cache_dir' => __DIR__, 'debug' => true, 'generator_class' => 'Hautelook\\TemplatedUriRouter\\Routing\\Generator\\Rfc6570Generator', 'generator_base_class' => 'Hautelook\\TemplatedUriRouter\\Routing\\Generator\\Rfc6570Generator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'ap_devRF6570UrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'ap_devRFC6570UrlMatcher'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'ife.aloes.type.cato_selector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ife\AloesBundle\Form\CatoSelectorType A Ife\AloesBundle\Form\CatoSelectorType instance.
     */
    protected function getIfe_Aloes_Type_CatoSelectorService()
    {
        return $this->services['ife.aloes.type.cato_selector'] = new \Ife\AloesBundle\Form\CatoSelectorType($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'ife.aloes.type.typo_selector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ife\AloesBundle\Form\TypoSelectorType A Ife\AloesBundle\Form\TypoSelectorType instance.
     */
    protected function getIfe_Aloes_Type_TypoSelectorService()
    {
        return $this->services['ife.aloes.type.typo_selector'] = new \Ife\AloesBundle\Form\TypoSelectorType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/aloes/');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/aloes-public/');
        ...
        $q = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $p, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($p, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $r->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => '/aloes/programs/list', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\fr3d\\ldap-bundle/Resources/translations\\validators.en.yml'), 'en', 'validators');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Ife\\AloesBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Ife\\AloesBundle/Resources/views'), 'IfeAloes');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('bc361b76ab7bd6fb0e55e63816c65240a01900d3');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $b = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_RESPONSABLE', 2 => 'ROLE_ENSEIGNANT'), 'ROLE_RESPONSABLE' => array(0 => 'ROLE_RESPONSABLE', 1 => 'ROLE_ENSEIGNANT'), 'ROLE_ENSEIGNANT' => array(0 => 'ROLE_ENSEIGNANT'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    ...
    {
        return $this->services['twig.form.renderer'] = new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig', 2 => 'SCDatetimepickerBundle:Form:div_layout.html.twig', 3 => 'SCDatetimepickerBundle:Form:jquery_layout.html.twig', 4 => 'SCDatetimepickerBundle:Form:stylesheet_layout.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IfeAloesBundle' => 'Ife\\AloesBundle\\IfeAloesBundle',
            ...
            'locale' => 'fr',
            'secret' => 'bc361b76ab7bd6fb0e55e63816c65240a01900d3',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'bc361b76ab7bd6fb0e55e63816c65240a01900d3',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.xxxx.fr',
            ...
            'fos_user.model.user.class' => 'Ife\\AloesBundle\\Entity\\User',
            ...
            'stfalcon_tinymce.config' => array(
                ...
                'theme' => array(
                    'simple' => array(
                        'plugins' => array(
                            0 => 'code,preview,link,fullscreen ',
                        ),
                        'menubar' => false,
                        'statusbar' => true,
